%%
%“Main_ShotNoiseEffect.m”: Ready-to-run code to generate the phase error distribution and the associated enhancement ratio 
% under the effect of shot noise, without camera noises as demonstrated in Figure 3."
%%
clear; close all;
