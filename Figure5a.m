...
%% Camera setting 
%% Figure 5a : is_digitization = 1;is_readnoise =0;is_shotnoise = 0;
...
FW = 10000;
% Bitdepth_list : list of bit depth
...
for repetition = 1:10
    ...
    savefol=['./ensemble40_0515_10000_5a/' , num2str(repetition) '/']
...
savefig(h3,[savefol  datestr(now,'HHMMSS') '5a_enhancement_merge_ELEC' num2str(Noise_list(noise_index)) '.fig']);
save([savefol  datestr(now,'HHMMSS') '5a_allbit_ELEC'  '.mat'],'valuelist_option_rot','enhancement_option_rot','ref_photon_num_list','signal_photon_num_list','photonpars','M','N',  'ref_index','Camera','indexpars','graphicpars','option_list','option')
